...
/**
 * Class Proxy
 * @ControllerAnnotation(title="代理管理",auth=false)
 */
class Proxy extends AdminController
{
    protected $middleware = [ProxyCheck::class];
    ...
    public function index()
    {
        if ($this->request->isAjax()) {
            ...
            // $authWhere = ' id != ' . AdminConstant::SUPER_ADMIN_ID;
            $authWhere[] = ['id', '>', AdminConstant::SUPER_ADMIN_ID];
