...
// +----------------------------------------------------------------------
return [
    '-1' => 'system error系统繁忙，此时请开发者稍候再试',
    '0' => 'ok请求成功',
    '1003' => 'POST参数非法',
    '20002' => '商品 id 不存在',
    '40001' => 'invalid credential, access_token is invalid or not latest获取 access_token 时 AppSecret 错误，或者 access_token 无效。请开发者认真比对 AppSecret 的正确性，或查看是否正在为恰当的公众号调用接口',
    '40002' => 'invalid grant_type不合法的凭证类型',
    '40003' => 'invalid openid不合法的 OpenID ，请开发者确认 OpenID （该用户）是否已关注公众号，或是否是其他公众号的 OpenID',
    '40004' => 'invalid media type不合法的媒体文件类型',
    '40005' => 'invalid file type上传素材文件格式不对',
    '40006' => 'invalid meida size上传素材文件大小超出限制',
    '40007' => 'invalid media_id不合法的媒体文件 id',
    '40008' => 'invalid message type不合法的消息类型',
    '40009' => 'invalid image size图片尺寸太大',
    '40010' => 'invalid voice size不合法的语音文件大小',
    '40011' => 'invalid video size不合法的视频文件大小',
    '40012' => 'invalid thumb size不合法的缩略图文件大小',
    '40013' => 'invalid appid不合法的appid',
    '40014' => 'invalid access_token不合法的 access_token ，请开发者认真比对 access_token 的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口',
    '40015' => 'invalid menu type不合法的菜单类型',
    '40016' => 'invalid button size不合法的按钮个数',
    '40017' => 'invalid button type不合法的按钮类型',
    '40018' => 'invalid button name size不合法的按钮名字长度',
    '40019' => 'invalid button key size不合法的按钮 KEY 长度',
    '40020' => 'invalid button url size不合法的按钮 URL 长度',
    '40021' => 'invalid menu version不合法的菜单版本号',
    '40022' => 'invalid sub_menu level不合法的子菜单级数',
    '40023' => 'invalid sub button size不合法的子菜单按钮个数',
    '40024' => 'invalid sub button type不合法的子菜单按钮类型',
    '40025' => 'invalid sub button name size不合法的子菜单按钮名字长度',
    '40026' => 'invalid sub button key size不合法的子菜单按钮 KEY 长度',
    '40027' => 'invalid sub button url size不合法的子菜单按钮 URL 长度',
    '40028' => 'invalid menu api user不合法的自定义菜单使用用户',
    '40029' => 'invalid code无效的 oauth_code',
    '40030' => 'invalid refresh_token不合法的 refresh_token',
    '40031' => 'invalid openid list不合法的 openid 列表',
    '40032' => 'invalid openid list size不合法的 openid 列表长度',
    ...
    '40035' => 'invalid args size不合法的参数',
    '40036' => 'invalid template_id size不合法的 template_id 长度',
    '40037' => 'invalid template_id不合法的 template_id',
    '40038' => 'invalid packaging type不合法的请求格式',
    '40039' => 'invalid url size不合法的 URL 长度',
    ...
    '40116' => 'invalid code',
    '40117' => 'invalid button media_id size分组名字不合法',
    '40118' => 'invalid sub button media_id sizemedia_id 大小不合法',
    '40119' => 'invalid use button typebutton 类型错误',
    '40120' => 'invalid use sub button type子 button 类型错误',
    '40121' => 'invalid media type in view_limited不合法的 media_id 类型',
    '40122' => 'invalid card quantity',
    '40123' => 'invalid task_id',
    '40124' => 'too many custom field!',
    '40125' => 'invalid appsecret不合法的 AppID ，请开发者检查 AppID 的正确性，避免异常字符，注意大小写',
    ...
    '40137' => 'invalid image format不支持的图片格式',
    ...
    '40155' => 'please don\'t contain other home page url请勿添加其他公众号的主页链接',
    ...
    '40163' => 'code been usedoauth_code已使用',
    ...
    '40199' => 'waybill_id not found运单 ID 不存在，未查到运单',
    ...
    '40210' => 'invalid check wxa pathpages 中的 path 参数不存在或为空',
    '40211' => 'invalid scope_data',
    '40212' => 'invalid querypaegs 当中存在不合法的query，query格式遵循 URL 标准，即k1=v1&k2=v2',
    ...
    '40219' => 'pages is emptypages不存在或者参数为空',
    '40220' => 'data_list is empty',
    '40221' => 'invalid Content-Encoding',
    '40222' => 'invalid request idc domain',
    '41001' => 'access_token missing缺少 access_token 参数',
    '41002' => 'appid missing缺少 appid 参数',
    '41003' => 'refresh_token missing缺少 refresh_token 参数',
    '41004' => 'appsecret missing缺少 secret 参数',
    '41005' => 'media data missing缺少多媒体文件数据，传输素材无视频或图片内容',
    '41006' => 'media_id missing缺少 media_id 参数',
    '41007' => 'sub_menu data missing缺少子菜单数据',
    '41008' => 'missing code缺少 oauth code',
    '41009' => 'missing openid缺少 openid',
    '41010' => 'missing url缺失 url 参数',
    ...
    '42001' => 'access_token expiredaccess_token 超时，请检查 access_token 的有效期，请参考基础支持 - 获取 access_token 中，对 access_token 的详细机制说明',
    '42002' => 'refresh_token expiredrefresh_token 超时',
    '42003' => 'code expiredoauth_code 超时',
    '42004' => 'plugin token expired',
    '42005' => 'api usage expired',
    '42006' => 'component_access_token expired',
    '42007' => 'access_token and refresh_token exception用户修改微信密码， accesstoken 和 refreshtoken 失效，需要重新授权',
    '42008' => 'voip call key expired',
    '42009' => 'client tmp token expired',
    '43001' => 'require GET method需要 GET 请求',
    '43002' => 'require POST method需要 POST 请求',
    '43003' => 'require https需要 HTTPS 请求',
    '43004' => 'require subscribe需要接收者关注',
    '43005' => 'require friend relations需要好友关系',
    ...
    '43016' => 'require verify小程序未认证',
    '43017' => 'require location id!',
    '43018' => 'code has no been mark!',
    '43019' => 'require remove blacklist需要将接收者从黑名单中移除',
    '43100' => 'change template too frequently',
    '43101' => 'user refuse to accept the msg用户拒绝接受消息，如果用户之前曾经订阅过，则表示用户取消了订阅关系',
    ...
    '44001' => 'empty media data多媒体文件为空',
    '44002' => 'empty post dataPOST 的数据包为空',
    '44003' => 'empty news data图文消息内容为空',
    '44004' => 'empty content文本消息内容为空',
    '44005' => 'empty list size空白的列表',
    ...
    '45001' => 'media size out of limit多媒体文件大小超过限制',
    '45002' => 'content size out of limit消息内容超过限制',
    '45003' => 'title size out of limit标题字段超过限制',
    '45004' => 'description size out of limit描述字段超过限制',
    '45005' => 'url size out of limit链接字段超过限制',
    '45006' => 'picurl size out of limit图片链接字段超过限制',
    '45007' => 'playtime out of limit语音播放时间超过限制',
    '45008' => 'article size out of limit图文消息超过限制',
    '45009' => 'reach max api daily quota limit接口调用超过限制',
    '45010' => 'create menu limit创建菜单个数超过限制',
    '45011' => 'api minute-quota reach limit, must slower, retry next minuteAPI 调用太频繁，请稍候再试',
    '45012' => 'template size out of limit模板大小超过限制',
    '45013' => 'too many template args',
    '45014' => 'template message size out of limit',
    '45015' => 'response out of time limit or subscription is canceled回复时间超过限制',
    '45016' => 'can\'t modify sys group系统分组，不允许修改',
    '45017' => 'can\'t set group name too long sys group分组名字过长',
    '45018' => 'too many group now, no need to add new分组数量超过上限',
    ...
    '45047' => 'out of response count limit客服接口下行条数超过上限',
    ...
    '45064' => 'no permission to use weapp in menu创建菜单包含未关联的小程序',
    '45065' => 'clientmsgid exist相同 clientmsgid 已存在群发记录，返回数据中带有已存在的群发任务的 msgid',
    '45066' => 'same clientmsgid retry too fast相同 clientmsgid 重试速度过快，请间隔1分钟重试',
    '45067' => 'clientmsgid size out of limitclientmsgid 长度超过限制',
    ...
    '45072' => 'invalid commandcommand字段取值不对',
    ...
    '45080' => 'need sending message to user, or recving message from user in the last 30 seconds before typing下发输入状态，需要之前30秒内跟用户有过消息交互',
    '45081' => 'you are already typing已经在输入状态，不可重复下发',
    ...
    '46001' => 'media data no exist不存在媒体数据，media_id 不存在',
    '46002' => 'menu version no exist不存在的菜单版本',
    '46003' => 'menu no exist不存在的菜单数据',
    '46004' => 'user no exist不存在的用户',
    '46005' => 'poi no exist',
    ...
    '47001' => 'data format error解析 JSON/XML 内容错误',
    ...
    '47004' => 'submit pages count more than each quota每次提交的页面数超过1000（备注：每次提交页面数应小于或等于1000）',
    '47005' => 'tabbar no exist',
    '47006' => 'submit pages count reach daily limit, please try tomorrow当天提交页面数达到了配额上限，请明天再试',
    '47101' => 'search results count more than limit搜索结果总数超过了1000条',
    '47102' => 'next_page_info errornext_page_info参数错误',
    '47501' => 'activity_id error参数 activity_id 错误',
    '47502' => 'target_state error参数 target_state 错误',
    '47503' => 'version_type error参数 version_type 错误',
    '47504' => 'activity_id expired timeactivity_id',
    '48001' => 'api unauthorizedapi 功能未授权，请确认公众号已获得该接口，可以在公众平台官网 - 开发者中心页中查看接口权限',
    '48002' => 'user block receive message粉丝拒收消息（粉丝在公众号选项中，关闭了 “ 接收消息 ” ）',
    '48003' => 'user not agree mass-send protocol',
    '48004' => 'api forbidden for irregularities, view detail on mp.weixin.qq.comapi 接口被封禁，请登录 mp.weixin.qq.com 查看详情',
    '48005' => 'forbid to delete material used by auto-reply or menuapi 禁止删除被自动回复和自定义菜单引用的素材',
    '48006' => 'forbid to clear quota because of reaching the limitapi 禁止清零调用次数，因为清零次数达到上限',
    '48007' => 'forbid to use other\'s voip call key',
    '48008' => 'no permission for this msgtype没有该类型消息的发送权限',
    ...
    '50001' => 'api unauthorized or user unauthorized用户未授权该 api',
    '50002' => 'user limited用户受限，可能是用户帐号被冻结或注销',
    '50003' => 'user unexpected, maybe not in white list',
    '50004' => 'user not allow to use accesstoken, maybe for punishment',
    '50005' => 'user is unsubscribed用户未关注公众号',
    ...
    '53010' => 'nickname invalid名称格式不合法',
    '53011' => 'check nickname too frequently名称检测命中频率限制',
    '53012' => 'nickname ban禁止使用该名称',
    '53013' => 'nickname has been occupied公众号：名称与已有公众号名称重复;小程序：该名称与已有小程序名称重复',
    ...
    '53018' => 'nickname hit alias名称命中微信号',
    '53019' => 'nickname protected by infringement名称在保护期内',
    '53100' => 'order not found',
    '53101' => 'order already paid',
    '53102' => 'already has checking order, can not apply',
    '53103' => 'order can not do refill',
    '53200' => 'modify signature quota limit exceed本月功能介绍修改次数已用完',
    '53201' => 'signature in black list, can not use功能介绍内容命中黑名单关键字',
    '53202' => 'modify avatar quota limit exceed本月头像修改次数已用完',
    ...
    '61004' => 'access clientip is not registeredapi 功能未授权，请确认公众号/小程序已获得该接口，可以在公众平台官网 - 开发者中心页中查看接口权限',
    ...
    '63001' => 'some arguments is empty部分参数为空',
    '63002' => 'invalid signature无效的签名',
    ...
    '65301' => 'this menu is not conditionalmenu不存在此 menuid 对应的个性化菜单',
    '65302' => 'no such user没有相应的用户',
    '65303' => 'there is no selfmenu, please create selfmenu first没有默认菜单，不能创建个性化菜单',
    '65304' => 'match rule emptyMatchRule 信息为空',
    '65305' => 'menu count limit个性化菜单数量受限',
    '65306' => 'conditional menu not support不支持个性化菜单的帐号',
    '65307' => 'conditional menu is empty个性化菜单信息为空',
    '65308' => 'exist empty button act包含没有响应类型的 button',
    '65309' => 'conditional menu switch is closed个性化菜单开关处于关闭状态',
    '65310' => 'region info: country is empty填写了省份或城市信息，国家信息不能为空',
    '65311' => 'region info: province is empty填写了城市信息，省份信息不能为空',
    '65312' => 'invalid country info不合法的国家信息',
    '65313' => 'invalid province info不合法的省份信息',
    '65314' => 'invalid city info不合法的城市信息',
    '65315' => 'not fans',
    '65316' => 'domain count reach limit该公众号的菜单设置了过多的域名外跳（最多跳转到 3 个域名的链接）',
    '65317' => 'contain invalid url不合法的 URL',
    ...
    '73217' => '礼品卡本身没有设置 appname 和path，不允许在修改接口设置',
    ...
    '85001' => 'user not exist or user cannot be searched微信号不存在或微信号设置为不可搜索',
    '85002' => 'number of tester reach bind limit小程序绑定的体验者数量达到上限',
    '85003' => 'user already bind too many weapps微信号绑定的小程序体验者达到上限',
    '85004' => 'user already bind微信号已经绑定',
    '85005' => 'appid not bind weapp',
    '85006' => 'tag is in invalid format标签格式错误',
    '85007' => 'page is in invalid format页面路径错误',
    '85008' => 'category is in invalid format当前小程序没有已经审核通过的类目，请添加类目成功后重试',
    '85009' => 'already submit a version under auditing已经有正在审核的版本',
    '85010' => 'missing required dataitem_list 有项目为空',
    '85011' => 'title is in invalid format标题填写错误',
    '85012' => 'invalid audit id无效的审核 id',
    '85013' => 'invalid ext_json, parse fail or containing invalid path无效的自定义配置',
    '85014' => 'template not exist无效的模板编号',
    '85015' => '该账号不是小程序账号',
    '85016' => 'exceed valid domain count域名数量超过限制 ，总数不能超过1000',
    '85017' => 'no domain to modify after filtered, please confirm the domain has been set in miniprogram or open没有新增域名，请确认小程序已经添加了域名或该域名是否没有在第三方平台添加',
    '85018' => '域名没有在第三方平台设置',
    '85019' => 'no version is under auditing没有审核版本',
    '85020' => 'status not allowed审核状态未满足发布',
    '85021' => 'status not allowed',
    '85022' => 'invalid action',
    '85023' => 'item size is not in valid range审核列表填写的项目数不在 1-5 以内',
    ...
    '85044' => 'package exceed max limit代码包超过大小限制',
    '85045' => 'some path in ext_json not existext_json 有不存在的路径',
    '85046' => 'pagepath missing in tabbar listtabBar 中缺少 path',
    '85047' => 'pages are emptypages 字段为空',
    '85048' => 'parse ext_json failext_json 解析失败',
    '85049' => 'reach headimg or introduction quota limit',
    '85050' => 'verifying, don\'t apply again',
    '85051' => 'data too largeversion_desc或者preview_info超限',
    ...
    '85064' => 'template not found找不到模板',
    '85065' => 'template list is full模板库已满',
    '85066' => 'illegal prefix链接错误',
    '85067' => 'input data error',
    '85068' => 'test url is not the sub prefix测试链接不是子链接',
    '85069' => 'check confirm file fail校验文件失败',
    '85070' => 'prefix in black list个人类型小程序无法设置二维码规则',
    '85071' => 'prefix added repeated已添加该链接，请勿重复添加',
    '85072' => 'prefix owned by other该链接已被占用',
    '85073' => 'prefix beyond limit二维码规则已满',
    '85074' => 'not published小程序未发布, 小程序必须先发布代码才可以发布二维码跳转规则',
    '85075' => 'can not access个人类型小程序无法设置二维码规则',
    '85077' => 'some category you choose is no longger supported, please choose other category小程序类目信息失效（类目中含有官方下架的类目，请重新选择类目）',
    '85078' => 'operator info error',
    '85079' => 'miniprogram has no online release小程序没有线上版本，不能进行灰度',
    '85080' => 'miniprogram commit not approved小程序提交的审核未审核通过',
    '85081' => 'invalid gray percentage无效的发布比例',
    '85082' => 'gray percentage too low当前的发布比例需要比之前设置的高',
    '85083' => 'search status is banned搜索标记位被封禁，无法修改',
    '85084' => 'search status invalid非法的 status 值，只能填 0 或者 1',
    '85085' => 'submit audit reach limit pleasetry later小程序提审数量已达本月上限，请点击查看《自助临时申请额度》',
    '85086' => 'must commit before submit audit提交代码审核之前需提前上传代码',
    '85087' => 'navigatetominiprogram appid list empty小程序已使用 api navigateToMiniProgram，请声明跳转 appid 列表后再次提交',
    '85088' => 'no qbase privilege',
    '85089' => 'config not found',
    '85090' => 'wait and commit for this exappid later',
    '85091' => 'search status was turned off小程序的搜索开关被关闭。请访问设置页面打开开关再重试',
    '85092' => 'invalid preview_info formatpreview_info格式错误',
    '85093' => 'invalid preview_info sizepreview_info 视频或者图片个数超限',
    '85094' => 'need add ugc declare需提供审核机制说明信息',
    '85101' => '小程序不能发送该运动类型或运动类型不存在',
    '85102' => '数值异常',
    '86000' => 'should be called only from third party不是由第三方代小程序进行调用',
    '86001' => 'component experience version not exists不存在第三方的已经提交的代码',
    '86002' => 'miniprogram have not completed init procedure小程序还未设置昵称、头像、简介。请先设置完后再重新提交',
    ...
    '87006' => 'this is game miniprogram, submit audit is forbidden小游戏不能提交',
    '87007' => 'session_key is not existd or expired',
    '87008' => 'invalid sig_method',
    '87009' => 'invalid signature无效的签名',
    '87010' => 'invalid buffer size',
    '87011' => 'wxa has a gray release plan, forbid revert release现网已经在灰度发布，不能进行版本回退',
    '87012' => 'forbid revert this version release该版本不能回退，可能的原因：1:无上一个线上版用于回退 2:此版本为已回退版本，不能回退 3:此版本为回退功能上线之前的版本，不能回退',
    '87013' => 'no quota to undo code撤回次数达到上限（每天5次，每个月 10 次）',
    '87014' => 'risky content',
    ...
    '89000' => 'account has bound openaccount has bound open，该公众号/小程序已经绑定了开放平台帐号',
    '89001' => 'not same contractornot same contractor，Authorizer 与开放平台帐号主体不相同',
    '89002' => 'open not existsopen not exists，该公众号/小程序未绑定微信开放平台帐号。',
    '89003' => 'open is not created by api该开放平台帐号并非通过 api 创建，不允许操作',
    ...
    '89019' => 'webview domain not change业务域名无更改，无需重复设置',
    ...
    '89029' => 'webview domain exceed limit业务域名数量超过限制，最多可以添加100个业务域名',
    ...
    '89231' => 'not support single个人小程序不支持调用 setwebviewdomain 接口',
    '89235' => 'hit black contractor',
    '89236' => 'this plugin can not apply该插件不能申请',
    '89237' => 'plugin has send apply message or already bind已经添加该插件',
    '89238' => 'plugin count reach limit申请或使用的插件已经达到上限',
    '89239' => 'plugin no exist该插件不存在',
    ...
    '89243' => 'can not delete apply request in 24 hours该申请为“待确认”状态，不可删除',
    '89244' => 'plugin appid is no in the plugin list, make sure plugin appid is right不存在该插件 appid',
    '89245' => 'mini program forbidden to link',
    '89246' => 'plugins with special category are used only by specific apps',
    '89247' => 'inner error, retry after some while系统内部错误',
    '89248' => '企业代码类型无效，请选择正确类型填写',
    '89249' => 'task running',
    '89250' => 'inner error, retry after some while内部错误',
    '89251' => 'legal person checking模板消息已下发，待法人人脸核身校验',
    '89253' => 'front checking法人&企业信息一致性校验中',
    '89254' => 'lack of some component rights',
    '89255' => 'enterprise code invalidcode参数无效，请检查 code 长度以及内容是否正确；注意code_type的值不同需要传的 code 长度不一样',
    '89256' => 'no component infotoken 信息有误',
    '89257' => 'no such version该插件版本不支持快速更新',
    '89258' => 'code is gray online当前小程序帐号存在灰度发布中的版本，不可操作快速更新',
    '89259' => 'zhibo plugin is not allow to delete',
    '89300' => 'invalid trade订单无效',
    ...
    '89506' => '该 IP 调用求请求已被公众号管理员拒绝，请24小时后再试，建议调用前与管理员沟通确认',
    '89507' => '该 IP 调用求请求已被公众号管理员拒绝，请1小时后再试，建议调用前与管理员沟通确认',
    ...
    '91001' => 'not fast register不是复用公众号接口快速创建的小程序 ，也不是通过快速注册企业小程序 api 创建的小程序',
    '91002' => 'has published小程序发布后不可改名',
    '91003' => 'invalid change stat改名状态不合法',
    '91004' => 'invalid nickname昵称不合法',
    '91005' => 'nickname protected昵称 15 天主体保护',
    '91006' => 'nickname used by username昵称命中微信号',
    '91007' => 'nickname used昵称已被占用',
    '91008' => 'nickname protected昵称命中 7 天侵权保护期',
    '91009' => 'nickname need proof需要提交材料',
    '91010' => '其他错误',
    '91011' => '查不到昵称修改审核单信息',
    '91012' => '其它错误',
    '91013' => 'lock name too more占用名字过多',
    '91014' => 'diff master plus+号规则 同一类型关联名主体不一致',
    '91015' => 'diff master原始名不同类型主体不一致',
    '91016' => 'name more owner名称占用者 ≥2',
    ...
    '93018' => '服务能力中填写的小程序 appid 不是同主体小程序',
    ...
    '930559' => 'invaild openid沙盒环境 openid 无效',
    '930560' => 'shopid need bind first',
    '930561' => 'args error参数错误',
    '930562' => 'order already exists',
    '930563' => 'order not exists订单不存在',
    '930564' => 'quota run out, try next day沙盒环境调用无配额',
    '930565' => 'order finished',
    '930566' => 'not support, plz auth at mp.weixin.qq.com',
    '930567' => 'shop arg error',
    '930568' => 'not personal account不支持个人类型小程序',
    '930569' => 'already open已经开通不需要再开通',
    ...
    '9300501' => 'Delivery side error快递侧逻辑错误，详细原因需要看 delivery_resultcode, 请先确认一下编码方式，python建议 json.dumps(b, ensure_ascii=False)，php建议 json_encode($arr, JSON_UNESCAPED_UNICODE)',
    '9300502' => 'Delivery side sys error快递公司系统错误',
    '9300503' => 'Specified delivery id is not registerreddelivery_id 不存在',
    '9300504' => 'Specified delivery id has beed bannedservice_type 不存在',
    '9300505' => 'Shop banned',
    '9300506' => 'Order can\'t cancel运单 ID 已经存在轨迹，不可取消',
    '9300507' => 'invalid token, can\'t decryption or decryption result is different from the plaintextToken 不正确',
    '9300508' => 'order id has been used',
    '9300509' => 'speed limit, retry too fast',
    '9300510' => 'invalid service type',
    '9300511' => 'invalid branch id',
    '9300512' => 'invalid waybill template format模板格式错误，渲染失败',
    ...
    '9300524' => 'order already canceled订单已取消（一般为重复取消订单）',
    '9300525' => 'biz id not bindbizid未绑定',
    '9300526' => 'arg size exceed limit参数字段长度不正确',
    '9300527' => 'delivery does not support quota',
    '9300528' => 'invalid waybill_id',
    '9300529' => 'biz_id already binded账号已绑定过',
    '9300530' => 'biz_id is not exist解绑的biz_id不存在',
    '9300531' => 'invalid biz_id or passwordbizid无效 或者密码错误',
    '9300532' => 'bind submit, and is checking绑定已提交，审核中',
    '9300533' => 'invalid tagid_list',
    '9300534' => 'invalid appid, not same bodyadd_source=2时，wx_appid和当前小程序不同主体',
    '9300535' => 'invalid shop argshop字段商品缩略图 url、商品名称为空或者非法，或者商品数量为0',
    '9300536' => 'invalid wxa_appidadd_source=2时，wx_appid无效',
    '9300537' => 'freq limit',
    ...
    '9300811' => '只支持 mmbiz.qpic.cn 域名的图片',
    '9300812' => '达到导购绑定个数限制',
    ...
    '9402202' => 'concurrent limit请勿频繁提交，待上一次操作完成后再提交',
    ...
    '9403003' => '发送的微信号太多!',
    '9403004' => '存在错误的微信号!',
    '9410000' => 'live room not exsits直播间列表为空',
    '9410001' => 'inner error: get room fail获取房间失败',
    '9410002' => 'inner error: get goods fail获取商品失败',
    '9410003' => 'inner error: get replay url fail获取回放失败',
    '800059' => 'error: xxxx, file not found参数中的 tabBar 的pagePath中传入的路径，找不到该文件',
];
